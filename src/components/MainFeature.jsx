    ...
    return (
        ...
        <div className="max-w-[800px] mx-auto sm:text-center">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <h2 className="mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-slate-900 text-center sm:text-4xl md:mx-auto">
              Visibility for your entire company.
            </h2>
